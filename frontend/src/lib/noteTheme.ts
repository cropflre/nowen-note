export const NOTE_THEME_IDS = ["default", "paper", "minimal", "eye-care"] as const;
...
const defaultLight: NoteThemeTokens = {
  ...
  contentMaxWidth: "860px", lineHeight: "1.75",
};
...
export const NOTE_THEMES: readonly NoteThemeDefinition[] = [
  {
    ...
    description: { zh: "保持当前界面与编辑器视觉。", en: "Keep the current Nowen editor appearance." },
    modes: { light: defaultLight, dark: defaultDark },
  },
  {
    id: "paper",
    name: { zh: "纸张阅读", en: "Paper Reading" },
    description: { zh: "温暖纸色、舒展行距，适合长文阅读。", en: "Warm paper tones and relaxed spacing for long-form reading." },
    modes: {
      light: {
        ...
        contentMaxWidth: "760px", lineHeight: "1.82",
      },
      dark: {
  ...
  },
  {
    ...
    modes: {
      light: {
        ...
        contentMaxWidth: "700px", lineHeight: "1.78",
      },
      dark: {
  ...
  {
    id: "eye-care",
    name: { zh: "柔和护眼", en: "Soft Eye Care" },
    description: { zh: "低对比自然色，适合长时间整理与阅读。", en: "Gentle natural colors for extended reading and editing." },
    modes: {
      light: {
        surface: "#f3f6ed", text: "#3f4a3c", heading: "#253225", muted: "#74806f",
        border: "#cfd8c8", accent: "#4f7457", accentHover: "#36563d",
        inlineCodeBackground: "#e2e9dd", inlineCodeText: "#7a4b43",
        preBackground: "#273129", preText: "#e5ede1", quoteBorder: "#6e936e",
        quoteText: "#5f6f5b", softBackground: "#e8eee2", tableStripe: "#edf2e8",
        markBackground: "#e3dfa0", selection: "rgba(79, 116, 87, 0.2)",
        contentMaxWidth: "800px", lineHeight: "1.8",
      },
      dark: {
        surface: "#17201a", text: "#cbd7c7", heading: "#e7efe4", muted: "#91a08d",
        border: "#344337", accent: "#8db394", accentHover: "#afd0b4",
        inlineCodeBackground: "#253028", inlineCodeText: "#d3a096",
        preBackground: "#0e1410", preText: "#e0e9dd", quoteBorder: "#66876b",
        quoteText: "#a9b8a5", softBackground: "#202a23", tableStripe: "#1c261f",
        markBackground: "#55531f", selection: "rgba(141, 179, 148, 0.22)",
        contentMaxWidth: "800px", lineHeight: "1.8",
      },
    },
  },
