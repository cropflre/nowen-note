...
| --- | --- | --- | --- | --- |
| `appearances` | 2.1 | 是 | `declarative`, `sandbox-js`, `node-action` | Safe semantic appearance tokens rendered by the host |
...
Appearance 最大数量：20；Note Template 最大正文：262144 字节；Prompt 最大正文：65536 字节。
