...
export function seedDatabase() {
  ...
  `).run(userId, "admin", "admin@mystation.local", passwordHash);
  ...
  const notes = [
    { notebookId: nb1Id, title: "项目启动会议纪要", content: '{"type":"doc","content":[{"type":"paragraph","content":[{"type":"text","text":"今天讨论了 MyStation 项目的整体架构方案..."}]}]}', contentText: "今天讨论了 MyStation 项目的整体架构方案..." },
    { notebookId: nb1Id, title: "Q1 目标与 OKR", content: '{"type":"doc","content":[{"type":"paragraph","content":[{"type":"text","text":"2026 年 Q1 核心目标：完成 MyStation v1.0 发布"}]}]}', contentText: "2026 年 Q1 核心目标：完成 MyStation v1.0 发布", isPinned: 1 },
